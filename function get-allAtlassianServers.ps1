function get-allatlassianServers
{
    <#
...
#>
    ...
    foreach ($server in $servers)
    {
        ...
        try
        {
            ...
            $installed = invoke-command -computername $server.dnshostname { Get-ItemProperty HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\* | Where-Object { $_.publisher -like "Atlassian" } | Sort-Object displayname | Select-Object DisplayName, Publisher } -ErrorAction SilentlyContinue
