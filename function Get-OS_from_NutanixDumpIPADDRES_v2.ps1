                ...
                {        
                    if ($vmip1 -eq $systemip)
                    {
                        ...
                        [PSCustomObject] @{
                            ...
                            "VM Name"                       = $vmserver."VM Name" 
                            "Creation Time"                 = $vmserver."Creation Time" 
                            "Container"                     = $vmserver."Container" 
                            "Protection Domain"             = $vmserver."Protection Domain"
                            "Host Placement"                = $vmserver."Host Placement" 
                            "hypervisorType"                = $vmserver."hypervisorType" 
                            "Power State"                   = $vmserver."Power State" 
                            "Network Name"                  = $vmserver."Network Name"
                            "Network adapters"              = $vmserver."Network adapters"
                            "IP Address(es)"                = $vmserver."IP Address(es)"
                            "vCPUs"                         = $vmserver."vCPUs" 
                            "Number of Cores"               = $vmserver."Number of Cores"
                            "Number of vCPUs per core"      = $vmserver."Number of vCPUs per core"  
                            "vRAM (GB)"                     = $vmserver."vRAM (GB)" 
                            "Disk Count"                    = $vmserver."Disk Count" 
                            "Provisioned Space (GB)"        = $vmserver."Provisioned Space (GB)" 
                            "Used Space (GB)"               = $vmserver."Used Space (GB)" 
                            "GPU Profile"                   = $vmserver."GPU Profile"
                            "VM description"                = $vmserver."VM description"
                            "VM Time Zone"                  = $vmserver."VM Time Zone" 
                            "Nutanix Guest Tools installed" = $vmserver."Nutanix Guest Tools installed" 
                            "NGT Version"                   = $vmserver."NGT Version"
                            "Categories"                    = $vmserver.Categories
                            "guestOperatingSystem"          = $system.OperatingSystem
