...
function Sophos
{
    ...
    \\qps-sav-pr-04.prds.qldpol\SophosUpdate\CIDs\S164\SAVSCFXP\setup.exe -mng yes -crt R -updp 'http://qps-sav-pr-04.prds.qldpol/sophosupdate/CIDs/S146/SAVSCFXP/' -G '\cit-sav-pr-01\SESC10\QPS Servers' -ni  2>&1 | Out-Null
